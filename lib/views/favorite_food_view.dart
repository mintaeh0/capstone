  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: (favoriteFoodViewModel.userData == null ||
                favoriteFoodViewModel.userData?[kFavsText] == null ||
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                          "${favoriteFoodViewModel.favFoods[index][kCarboText]}"),
                                      Text(
                                          "${favoriteFoodViewModel.favFoods[index][kProteinText]}"),
                                      Text(
                                          "${favoriteFoodViewModel.favFoods[index][kFatText]}"),
                                      Text(
                                          "${favoriteFoodViewModel.favFoods[index][kKcalText]}"),
                                    ],
                                  ),
                                  const Column(
                                    crossAxisAlignment:
                    ...
                    child: Card.outlined(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                                "${favoriteFoodViewModel.favFoods[index][kFoodNameText]}")
                          ],
                        ),
                      ),
                    ),
