...
import 'package:project1/function/add_goal_func.dart';
import 'package:project1/function/add_profile_func.dart';
import 'package:project1/function/goal_state_controller.dart';
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                        flex: 1,
                        child: heightInput(
                            profileSetViewModel.profileSetData?["height"] ??
                                "0")),
                ...
                nutriGoalInput(
                    profileSetViewModel.profileSetData?[goalKey[0]], 0),
                const SizedBox(height: 20),
                nutriGoalInput(
                    profileSetViewModel.profileSetData?[goalKey[1]], 1),
                const SizedBox(height: 20),
                nutriGoalInput(
                    profileSetViewModel.profileSetData?[goalKey[2]], 2),
                const SizedBox(height: 20),
                nutriGoalInput(
                    profileSetViewModel.profileSetData?[goalKey[3]], 3),
